...
// "student/CASA0014/plant/ucfnswu"
...
void sendMQTT() {
  ...
  client.loop();
  ++value;
  snprintf (msg, 50, "hi theree #%ld", value);
  Serial.print("Publish message: ");
  Serial.println(msg);
  client.publish("student/CASA0014/plant/ucfnswu", msg);

}

ioiihu// The callback function is called when an incoming message is received
